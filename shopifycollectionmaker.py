...
def process_keyword(keyword):
    ...
    title_prompt = f"WE DO NOT SELL FIRE-ARMS. ONLY ACCESSORIES. MAKE ALL CONTENT RELEVANT TO ACCESSORIES. Create one single SEO-Optimized meta title for {keyword}. This is for a business selling hunting & survival supplies. Use words like cheap, affordable, and buy at least once. Just add some words to it that people may search. Do not write anything else."
    title = generate_text(title_prompt)
    print(f"Generated Title: {title}")

    handle_prompt = f"WE DO NOT SELL FIRE-ARMS. ONLY ACCESSORIES. MAKE ALL CONTENT RELEVANT TO ACCESSORIES.  Generate a handle for a smart collection based on the keyword: {keyword}. This is for a business selling hunting & survival supplies. Just put hyphens between the words and replace special letters with hyphens. Do not do anything else."
    handle = generate_text(handle_prompt)
    print(f"Generated Handle: {handle}")

    body_prompt = f"WE DO NOT SELL FIRE-ARMS. ONLY ACCESSORIES. MAKE ALL CONTENT RELEVANT TO ACCESSORIES.  Generate a brief HTML description for a smart collection based on the keyword: {keyword}. This is for a business selling hunting & survival supplies. Just write 300 characters of a <p> description. Do not write anything else."
    ...
    return [keyword, title, handle, body_html, str(rules)]

# Main function to process keywords, generate content, and create smart collections
def process_keywords(input_csv, output_csv, max_workers=5):
...
if __name__ == "__main__":
    ...
    process_keywords(input_csv, output_csv, max_workers)